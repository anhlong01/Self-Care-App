...
import com.lph.selfcareapp.databinding.LoadStateItemBinding;

public class DoctorLoadStateAdapter extends LoadStateAdapter<DoctorLoadStateAdapter.LoadStateViewHolder> {
    private View.OnClickListener mRetryCallback;

    public DoctorLoadStateAdapter(View.OnClickListener mRetryCallback){
        this.mRetryCallback = mRetryCallback;
    }

    @Override
    public void onBindViewHolder(@NonNull DoctorLoadStateAdapter.LoadStateViewHolder loadStateViewHolder, @NonNull LoadState loadState) {
